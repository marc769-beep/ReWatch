 ...
 *
 * La pagina trae varios campos "description" (textos del propio Vinted, de la
 * categoria...), asi que quedarse con el primero devolvia casi siempre texto
 * generico y los filtros no llegaban a ver lo que escribio el vendedor. Aqui
 * se recogen todos los candidatos y se juntan los que parecen texto real: para
 * detectar "pantalla rota" o "icloud" conviene mirar de mas y no de menos.
 */
